...
const Navbar = () => {
  ...
  const {activeState, setActiveState, handleClick, screenSize, setScreenSize, currentColor} = useContext(StateContext)
  ...
  return (
    <div className="flex justify-between p-2 md:mx-6 relative">
      ...
      <div className="flex">
        ...
        >
          <div className="flex items-center gap-2 cursor-pointer p-1" onClick={()=> handleClick("userProfile")}>
            ...
            <p className="text-gray-400 text-14">
              <span >Hi, </span>{' '}
              <span className=" font-bold ml-1">Sarah</span>
            </p>
        ...
        {activeState.chat && <Chat/>}
        {activeState.notification && <Notification/>}
        {activeState.UserProfile && <UserProfile/>}
      </div>
    </div>
  );
};
